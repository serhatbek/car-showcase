        ...
        <Dialog as='div' className='relative z-10' onClose={closeModal}>
          ...
          <div className='fixed inset-0'>
            <div className='flex min-h-full items-center justify-center p-4 text-center'>
              ...
              >
                <DialogPanel className='relative w-full max-w-lg max-h-[90vh] transform rounded-2xl bg-white p-6 text-left shadow-xsl transition-all flex flex-col gap-5'>
                  <button
                    type='button'
                    onClick={closeModal}
                    className='absolute top-2 right-2 z-10 w-fit bg-primary-blue-100 rounded-full p-1.5'
                  >
                    <Image
                      src='/close.svg'
                      alt='close'
